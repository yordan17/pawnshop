    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/pawn-items/*/delete").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/contracts/*/edit").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/contracts/*/edit").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/contracts/*/delete").hasRole("ADMIN")
